...
namespace Shop.UI.Infrastructure
{
    public class SessionManager : ISessionManager
    {
        ...
        public void AddProduct(CartProduct cartProduct)
        {
            ...
            if (cartList.Any(s => s.StockId == cartProduct.StockId)) //if the product is already in cart
            {
        ...
        public void RemoveProduct(int stockId, int qty)
        {
            ...
            if (!cartList.Any(s => s.StockId == stockId)) return; //if the product is already in cart
